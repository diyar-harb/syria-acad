...
const Courses = () => {
  ...
  return (
    <div className="courses-page">
      <motion.section className="courses-hero" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8 }}>
      ...
      <section className="courses-content">
        <div className="container">
          <motion.div className="categories" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.6 }}>
          ...
          <motion.div
            ...
            {filteredCourses.map(course => (
              <motion.div key={course.id} className="course-card" variants={fadeIn} whileHover={{ y: -10, transition: { duration: 0.3 } }}>
                <h2>{course.title}</h2>
