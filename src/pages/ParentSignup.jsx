          ...
          {step === 1 && (
            <div className="form-step">
              ...
              <div className="form-group">
                ...
                <select name="relationship" value={formData.relationship} onChange={handleChange} className={errors.relationship ? 'error' : ''}>
          ...
          {step === 2 && showOTP && (
            <div className="form-step">
              <div className="form-group">
                ...
                <input type="text" name="otp" value={formData.otp} onChange={handleChange} className={errors.otp ? 'error' : ''} />
          ...
          {step === 3 && (
            <div className="form-step">
              <div className="form-group">
                ...
                <input type="text" name="studentCode" value={formData.studentCode} onChange={handleChange} placeholder="أدخل كود الطالب" />
              </div>
              <div className="or-divider">أو</div>
              <div className="form-group">
                <label>بريد الطالب الإلكتروني</label>
                <input type="email" name="studentEmail" value={formData.studentEmail} onChange={handleChange} placeholder="أدخل بريد الطالب الإلكتروني" />
              </div>
            </div>
          )}
