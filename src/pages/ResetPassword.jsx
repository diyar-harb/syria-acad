        ...
        <form onSubmit={handleSubmit}>
          ...
          {step === 2 && (
            <div className="form-group">
              ...
              <input type="text" id="otp" name="otp" value={formData.otp} onChange={handleChange} required placeholder="أدخل رمز التحقق المرسل إلى بريدك الإلكتروني" />
            </div>
          )}
          ...
          <button type="submit" className="btn btn-primary" disabled={loading}>
            {loading ? 'جاري المعالجة...' : step === 1 ? 'إرسال رمز التحقق' : step === 2 ? 'التحقق من الرمز' : 'تغيير كلمة المرور'}
          </button>
        </form>
      </div>
    </div>
