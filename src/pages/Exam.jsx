...
const Exam = () => {
  ...
  if (showInstructions) {
    return (
      <motion.div className="exam-instructions" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
  ...
  if (showResults) {
    return (
      <motion.div className="exam-results" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
