...
router.post('/request-password-reset', async (req, res) => {
  ...
  try {
    ...
    // Save reset token
    await pool.query('INSERT INTO reset_tokens (user_id, token, otp, expires_at) VALUES ($1, $2, $3, $4)', [user.id, token, otp, expiresAt])
...
router.post('/reset-password', async (req, res) => {
  ...
  try {
    ...
    await pool.query('UPDATE reset_tokens SET used = true WHERE user_id = $1 AND used = false', [userId])
